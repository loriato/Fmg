...
Europa.Components.Datatable.Funcionalidade.MudarPermissao = function(item,existe) {
    ...
    $.ajax({
        ...
        if (!response.Sucesso) {
            ChangeHeaderAndContent(Europa.i18n.Messages.Erro, Europa.Components.Datatable.Funcionalidade.FormatarMensagem(response.Mensagens));
            Show();
        }
    });
}
...
$(document).ready(function() {
    Europa.Components.Datatable.Funcionalidade.GetPerfilId = function() {
        if (Europa.Components.Datatable.Funcionalidade.PerfilId !== undefined) {
            ...
            ChangeHeaderAndContent(Europa.i18n.Messages.Erro, Europa.i18n.Messages.NecessarioDefinirPerfil);
            Show();
        }
        return undefined;
    };
