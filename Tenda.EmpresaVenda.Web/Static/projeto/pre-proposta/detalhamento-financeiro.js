...
function detalhamentoFinanceiroTable($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    function actionsHtml(data, type, full, meta) {
        ...
        if (Europa.Controllers.PreProposta.Permissoes.DetalhamentoFinanceiroManual) {
            div += $scope.renderButtonEdit(Europa.Controllers.PreProposta.DetalhamentoFinanceiro.Permissoes.Atualizar, "Editar", "fa fa-edit", "editar(" + meta.row + ")", full.Situacao);
            div += $scope.renderButtonDelete(Europa.Controllers.PreProposta.DetalhamentoFinanceiro.Permissoes.Excluir, "Excluir", "fa fa-trash", "excluir(" + meta.row + ")", full.Situacao);
        }
        return div+='</div>';
    }
