...
namespace Tenda.EmpresaVenda.Web.App_Start
{
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jexcel")
                .Include("~/static/jexcel/js/jexcel.js",
                    "~/static/jsuites/js/jsuites.js"));

            bundles.Add(new StyleBundle("~/css/jexcel")
                .Include("~/static/jexcel/css/jexcel.css",
                    "~/static/jsuites/css/jsuites.css"));
        }
    }
}