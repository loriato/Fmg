...
namespace Tenda.EmpresaVenda.Web.Security
{
    ...
    public static class PublicPages
    {
        ...
        public static bool IsPublicPage(AuthorizationContext filterContext)
        {
            if (_publicPages == null)
            {
                ...
                {
                    RegisterPublicPages(filterContext.HttpContext.Request.Url.Segments[1].ToLower() + "/");
                }
            }
            return _publicPages != null && _publicPages.Contains(filterContext.HttpContext.Request.Path.ToLower());
        }
        ...
        private static void RegisterPublicPages(string applicationPreffix)
        {
            _publicPages = new List<string>
            {
                ...
                applicationPreffix + "login",
                applicationPreffix + "login/index"
            };
        }
    }
}
