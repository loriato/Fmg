...
{
    public class EmAnaliseCompletaDocsInsuficientesCompletaRule : PrePropostaWorkflowBase
    {
        public EmAnaliseCompletaDocsInsuficientesCompletaRule()
        {
            Origem = SituacaoProposta.EmAnaliseCompleta;
            Destino = SituacaoProposta.DocsInsuficientesCompleta;
        ...
        public override bool Validate(PreProposta preProposta)
        {
            ...
            var documentosPendentesAvaliacao = new List<SituacaoAprovacaoDocumento>() {
