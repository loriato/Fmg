...
{
    public class PagamentoImportService
    {
        private ISession _session;
        private PagamentoRepository _pagamentoRepository;
        private ViewPagamentoRepository _viewPagamentoRepository;
        ...
        public void InternalProcess(string diretorio, ref ImportTaskDTO importTask)
        {
            ...
            _viewPagamentoRepository = new ViewPagamentoRepository()
            {
                _session = _session
            };
            ...
            if (validation)
            {
                ...
                var viewPagamentoInMemory = _viewPagamentoRepository.Queryable().ToList();
                //var pagamentoInMemory = _pagamentoRepository.Queryable().ToList();
                ...
                while (rowIndex < rowCount)
                {
                    try
                    {
                        ...
                        var propostaRelacionadaFornecedor = _viewPagamentoRepository.RelacionarEmpresaVendaProposta(idEmpresaVenda, proposta);
