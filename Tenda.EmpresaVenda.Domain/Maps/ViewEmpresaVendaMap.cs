...
{
    public class ViewEmpresaVendaMap : BaseClassMap<ViewEmpresaVenda>
    {
        public ViewEmpresaVendaMap()
        {
            Table("VW_EMPRESAS_VENDAS");
            ReadOnly();
            SchemaAction.None();
            ...
            Map(view => view.NomeCorretor).Column("NM_USUARIO");
            ...
            Map(view => view.CorretorVisualizarClientes).Column("FL_CORRETOR_VISUALIZAR_CLIENTES");
