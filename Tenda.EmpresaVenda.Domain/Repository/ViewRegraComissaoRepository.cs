...
{
    public class ViewRegraComissaoRepository : NHibernateRepository<ViewRegraComissao>
    {

        public IQueryable<ViewRegraComissao> Listar(FiltroRegraComissaoDTO filtro)
        {
