...
Europa.RemoveDoubleClickButton = function (idButton) {
    var text = document.getElementById(idButton).innerHTML;
    document.getElementById(idButton).classList.add('btn-bloq');
    document.getElementById(idButton).innerHTML = "5";
    setTimeout(function () { document.getElementById(idButton).innerHTML = "4"; }, 1000);
    setTimeout(function () { document.getElementById(idButton).innerHTML = "3"; }, 2000);
    setTimeout(function () { document.getElementById(idButton).innerHTML = "2"; }, 3000);
    setTimeout(function () { document.getElementById(idButton).innerHTML = "1"; }, 4000);
    setTimeout(function () {
        document.getElementById(idButton).innerHTML = text;
        document.getElementById(idButton).classList.remove('btn-bloq');
    }, 5000);
}