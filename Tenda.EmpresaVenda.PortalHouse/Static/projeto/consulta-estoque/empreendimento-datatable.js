...
function estoqueEmpreendimento($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    wrapper.setColumns([
        DTColumnBuilder.newColumn('NomeEmpreendimento').withTitle(Europa.i18n.Messages.Empreendimento).withOption('width', '13%')
            .withOption("link", wrapper.withOptionLink(Europa.Controllers.PreProposta.UrlDetalharEmpreendimento, "IdEmpreendimento")),
        ...
        DTColumnBuilder.newColumn('PrevisaoEntrega').withTitle(Europa.i18n.Messages.PrevisaoEntrega).withOption('width', '12%').renderWith(dateFormat)
    ])
