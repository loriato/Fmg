...
function historicoPrePropostaTable($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    self.setColumns([
        ...
        DTColumnBuilder.newColumn('SituacaoInicioPortalHouse').withTitle(Europa.i18n.Messages.Situacao).withOption('width', '150px'),
        ...
        DTColumnBuilder.newColumn('SituacaoTerminoPortalHouse').withTitle(Europa.i18n.Messages.Situacao).withOption('width', '150px'),
