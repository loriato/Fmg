            ...
            if (response.Sucesso) {
                self.Tabela.setCallBackReload(function () {
                    ...
                    for (var i = 0; i < 10; i++) {
                        ...
                        if (objLinha && objLinha.Id == response.Objeto) {
...
function proponentesTable($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    tabelaWrapper.
        ...
        .setTemplateEdit([
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditNomeCliente" name="NomeCliente" readonly="true">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditCpfCnpjCliente" name="CpfCnpjCliente" readonly="true">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditTitular" name="Titular" readonly="true">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditParticipacao" name="Participacao">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditEmail" name="Email" readonly="true">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditCelular" name="Celular" readonly="true">',
            '<input type="text" class="form-control form-control-sm" id="ProponenteEditResidencial" name="Residencial" readonly="true">'
        ])
