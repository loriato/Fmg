...
Europa.Controllers.PreProposta.DocumentoProponente.Init = function () {
    ...
    self.Upload = function () {
        Europa.RemoveDoubleClickButton('btn-upload-documento-preponente');
        ...
        if (arquivo !== undefined && arquivo.size > maxFileSizeInBytes) {
            ...
            document.getElementById('btn-upload-documento-preponente').classList.remove('btn-bloq');
            return;
        }
        Spinner.Show();
...
function documentoProponentesTable($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    function actionsHtml(data, type, full, meta) {
        var situacaoPreProposta = $("#SituacaoPrePropostaPortalHouse").val();
        var div = '<div>';
