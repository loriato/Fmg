...
function itbiEmolumentoTable($scope, $compile, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
    ...
    tabelaWrapper.
        ...
        .setTemplateEdit([
            ...
            '<input type="text" class="form-control form-control-sm" id="ItbiEmolumentoNumeroParcelasEdit" name="NumeroParcelas" maxlength="3" onblur="Europa.Controllers.PreProposta.ItbiEmolumento.AtualizarValorTotal()">',
            '<input type="text" class="form-control form-control-sm" id="ItbiEmolumentoValorParcelaEdit" name="ValorParcela" maxlength="10" style="text-align:right" onblur="Europa.Controllers.PreProposta.ItbiEmolumento.AtualizarValorTotal()">',
            '<input type="text" class="form-control form-control-sm" id="ItbiEmolumentoTotalEdit" name="Total" readonly="readonly" style="text-align:right">',
            '<input type="text" class="form-control form-control-sm" id="ItbiEmolumentoDataVencimentoEdit" name="DataVencimento" datepicker="datepicker">'
        ])
